...
<body>
    ...
    <div class="vernav2 iconmenu">
    	<ul>
		   ...
		   <li><a href="#management" class="typo">品牌管理</a>
            	<span class="arrow"></span>
            	<ul id="management">
			  ...
			  <li><a href="#management" class="tables">商品管理</a>
            	<span class="arrow"></span>
            	<ul id="management">
		   ...
		   <li><a href="#management" class="addons">订单管理</a>
            	<span class="arrow"></span>
            	<ul id="management">
			...
			<li><a href="#management" class="widgets">评论管理</a>
            	<span class="arrow"></span>
            	<ul id="management">
			  ...
			  <li><a href="#management" class="arrow">广告管理</a>
            	<span class="arrow"></span>
            	<ul id="management">
		   ...
		   <li><a href="#management" class="widgets">订单管理</a>
            	<span class="arrow"></span>
            	<ul id="management">
               		<li><a href="<?php echo U('Orders/index');?>">订单列表</a></li>
               		<li><a href="<?php echo U('Orders/statu_list');?>">订单状态列表</a></li>
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="<?php echo U('add');?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 添加分类</a>
	...
	<!-- 	<th>PID</th>
		...
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><tr>
			...
			<?php
 $arr=explode(',',$admin['path']); array_pop($arr); $size=count($arr); ?>
			<td><?php echo str_repeat('|===',$size-1); echo ($admin[cname]); ?></td>
			
			<?php if($size == 3): ?><td><a href="javascript:;" style="color:red;" class="glyphicon glyphicon-plus"></a></td>
				<?php else: ?>
				<td><a href="<?php echo U('add',array('pid'=>$admin[id],'path'=>$admin[path].$admin[id].','));?>" class="glyphicon glyphicon-plus"></a></td><?php endif; ?>
			
			<td><?php echo ($admin[info]); ?></td>
			<!-- <td><?php echo ($admin[pid]); ?></td> -->
			<!-- <td><?php echo ($admin[path]); ?></td> -->
			<td><a href="<?php echo U('edit');?>" class="glyphicon glyphicon-pencil"></a>&nbsp;&nbsp;&nbsp;<a href="" class="glyphicon glyphicon-trash"></a></td>
